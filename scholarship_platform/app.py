...
# --- HOMEPAGE ROUTE (ADDED FIX) ---
@app.route('/')
def home():
    return "ScholarlyWomen Backend is running successfully!"
...
def chat_with_ai():
    ...
    if "btech" in user_message or "engineering" in user_message:
        bot_response = "For B.Tech students, I recommend the AICTE Pragati Scheme for Girls. It offers ₹50,000/year."
    elif "kerala" in user_message:
        bot_response = "In Kerala, the Vidyadhan Scholarship is popular for high school and plus-two students."
    elif "medical" in user_message or "mbbs" in user_message:
        bot_response = "For Medical students, check the L'Oréal India For Young Women in Science grant."
    elif "document" in user_message:
        bot_response = "Usually you need Aadhar Card, Income Certificate, and previous year marksheets."
